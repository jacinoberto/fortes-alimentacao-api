...
namespace FortesAlimentacaoApi.Migrations
{
    ...
    [Migration("20240527234105_AtualizandoRelacionamentoEntreRefeicoesEDataObra")]
    partial class AtualizandoRelacionamentoEntreRefeicoesEDataObra
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FortesAlimentacaoApi.Database.Models.Refeicao", b =>
                {
                    ...
                    b.Property<Guid>("DataObraId")
                        .HasColumnType("uuid")
                        .HasColumnName("data_obra_id");
            ...
            modelBuilder.Entity("FortesAlimentacaoApi.Database.Models.Refeicao", b =>
                {
                    b.HasOne("FortesAlimentacaoApi.Database.Models.DataObra", "DataObra")
                        .WithMany("Refeicoes")
                        .HasForeignKey("DataObraId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
