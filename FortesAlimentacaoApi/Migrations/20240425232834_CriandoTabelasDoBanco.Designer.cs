...
namespace FortesAlimentacaoApi.Migrations
{
    ...
    [Migration("20240425232834_CriandoTabelasDoBanco")]
    partial class CriandoTabelasDoBanco
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FortesAlimentacaoApi.Database.Model.Admin", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Gestor", "FortesAlimentacaoApi.Database.Model.Admin.Gestor#Gestor", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("FortesAlimentacaoApi.Database.Model.ControleData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("FortesAlimentacaoApi.Database.Model.Encarregado", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Gestor", "FortesAlimentacaoApi.Database.Model.Encarregado.Gestor#Gestor", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("FortesAlimentacaoApi.Database.Model.Endereco", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("FortesAlimentacaoApi.Database.Model.Equipe", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("FortesAlimentacaoApi.Database.Model.GestaoEquipe", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("FortesAlimentacaoApi.Database.Model.Obra", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("FortesAlimentacaoApi.Database.Model.Operario", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("FortesAlimentacaoApi.Database.Model.Refeicao", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("FortesAlimentacaoApi.Database.Model.Equipe", b =>
                {
                    b.HasOne("FortesAlimentacaoApi.Database.Model.GestaoEquipe", "GestaoEquipe")
                        .WithMany("Equipes")
                        .HasForeignKey("GestaoEquipeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FortesAlimentacaoApi.Database.Model.Operario", "Operario")
                        .WithMany("Equipes")
            ...
            modelBuilder.Entity("FortesAlimentacaoApi.Database.Model.GestaoEquipe", b =>
                {
                    b.HasOne("FortesAlimentacaoApi.Database.Model.Encarregado", "Encarregrado")
                        .WithMany("GestaoEquipes")
                        .HasForeignKey("EncarregadoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FortesAlimentacaoApi.Database.Model.Obra", "Obra")
                        .WithMany("GestaoEquipes")
            ...
            modelBuilder.Entity("FortesAlimentacaoApi.Database.Model.Obra", b =>
                {
                    b.HasOne("FortesAlimentacaoApi.Database.Model.Endereco", "Endereco")
                        .WithMany("Obras")
            ...
            modelBuilder.Entity("FortesAlimentacaoApi.Database.Model.Refeicao", b =>
                {
                    b.HasOne("FortesAlimentacaoApi.Database.Model.ControleData", "ControleData")
                        .WithMany("Refeicoes")
                        .HasForeignKey("ControleDataId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FortesAlimentacaoApi.Database.Model.Equipe", "Equipe")
                        .WithMany("Refeicoes")
